    ...
    var define, module, exports;return function e(t, n, r) {
        ...
        function runTimeout(fun) {
            ...
            if ((cachedSetTimeout === defaultSetTimout || !cachedSetTimeout) && setTimeout) {
                cachedSetTimeout = setTimeout;
                return setTimeout(fun, 0);
                //settimeout에 의해 반환된 id값은 cleartimeout 메서드의 매개 변수로 사용
            }
            try {
        ...
        //timeout은 페이지 로드나 기능할 때 시간이 지난 후에 실행하게 될때 호출 ex) 10초마다 갱신
        ...
        module.exports = function () {
            ...
            API.request = function (settings) {
                ...
                function getFileConfig(files) {
                    //promise : 비동기계산할때, 아직은 아니지만 나중에 완료 기대
                    return new Promise(function (resolve, reject) {
        ...
        module.exports = function () {
            ...
            Auth.createLoginButton = function (settings) {
                ...
                }   //카카오 로그인 버튼 요소 및 아이디 필요
                var stateToken = '';

                //임시저장소 거쳐서 가져오도록 프록시설정
                var proxy = getProxy({
